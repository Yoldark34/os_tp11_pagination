...
#define INITIALISER_REGISTRE_CR3(Adresse_Repertoire_Table) \
                                 asm (".intel_syntax noprefix "); \
                                 asm( "mov eax,"VALEUR_DE(Adresse_Repertoire_Table)); \
                                 asm ("mov cr3, eax"); \
                                 asm (".att_syntax noprefix \n");

#define ACTIVER_PAGINATION       asm (".intel_syntax noprefix "); \
                                 asm (" mov eax,cr0"); \
